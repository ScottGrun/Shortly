...
import facebookIconSrc from '../../public/assets/icons/icon-facebook.svg';
import instagramIconSrc from '../../public/assets/icons/icon-instagram.svg';
import pinterestIconSrc from '../../public/assets/icons/icon-pinterest.svg';
import twitterIconSrc from '../../public/assets/icons/icon-twitter.svg';
import {
	footerLinkTextStyles,
	footerLinkTitleStyles,
...
export const Footer: React.FC<FooterProps> = ({ className }) => {
	return (
		<Wrapper className={className}>
			<Logo xmlns="http://www.w3.org/2000/svg" width="121" height="33">
				<path
					fill="#ffffff"
			...
			<IconsWrapper>
				<a href="#">
					<Image src={facebookIconSrc} alt="Facebook Logo Icon" />
				</a>
				<a href="#">
					<Image src={twitterIconSrc} alt="Twitter Logo Icon" />
				</a>
				<a href="#">
					<Image src={pinterestIconSrc} alt="Pinterest Logo Icon" />
				</a>
				<a href="#">
					<Image src={instagramIconSrc} alt="Instagram Logo Icon" />
				</a>
			</IconsWrapper>
		</Wrapper>
	);
...
const Wrapper = styled.footer`
	...
	align-items: center;
	padding: 56px;
	background-color: ${(p) => p.theme.COLORS.dark[800]};
